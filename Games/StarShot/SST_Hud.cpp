...
void
sstHud::Draw( vsDisplayList *list )
{
	float leftEdge = vsScreen::Instance()->GetLayer(1)->GetTopLeftCorner().x;
	float rightEdge = vsScreen::Instance()->GetLayer(1)->GetTopRightCorner().x;
