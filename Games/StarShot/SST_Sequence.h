...
#define MAX_BEATS (12)
	...
	vsTransform			m_transformA;	// we go from A to B over the course of m_start to m_end
	vsTransform			m_transformB;
...
/*	vsVector2D			m_positionA;	
	...
	vsTransform			m_currentTransform;
	...
	vsTransform			GetTransformAtTime( float time );
