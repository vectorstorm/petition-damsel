...
astModeTitleScreen::astModeTitleScreen( astGame *game ):
	m_game(game)
{
	m_menu = new utMenu( 4, 25.0f, 35.0f, 20.0f );
...
astModeTitleScreen::Init()
{
	...
	m_iniTitlePos.y = vsScreen::Instance()->GetLayer(1)->GetTopLeftCorner().y;
	m_iniMenuPos.x = vsScreen::Instance()->GetLayer(1)->GetTopRightCorner().x;
