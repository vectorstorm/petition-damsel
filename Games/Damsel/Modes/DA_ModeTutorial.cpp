...
daModeTutorial::Init()
{
	...
	vsString pageTwoLines[c_pageOneLines] = {
		...
		"darken and cannot sign any more petitions.",
		"",
		"But even then, his tragic roadside death could be",
		"worth even more political points.",
		"",
		"I mean, just speaking theoretically.",
		"",
		"Because hurting someone to further your",
		"political goals would be very wrong.",
		"",
		"",
		"<Page 3/5>"
	};
	...
	vsString pageFiveLines[c_pageOneLines] = {
		"This is a car.",
		"",
		"They are menaces, zooming along the highway",
		"at reckless speeds, hurting innocent pedestrians,",
		"destroying the environment, and being general",
		"nuisances.",  
		"",
